            ...
            <div class="text-center">
                <nav class="top-bar-wrap">
                    <ul class="top-bar">
                        ...
                        <li class="nav-item">
                            <a href="#" class="nav-link active"><span class="inner-link">Pengumuman</span></a>
                        </li>
                        <li class="nav-item">
                ...
                <h2>PENGUMUMAN</h2>
                <br>
                <p>Berikut adalah pengumuman mengenai layanan puskesmas kami.
                    Yang dimana pengumuman ini selalu terupdate
                    <br> <br><br>
                    

   <a href=""><img src="fotoimunisasi.png" alt="pengumuman" width="800" height="1200"></a>
   <br> <br><br><br>

                <a href=""><img src="gambarpengumuman.png" alt="pengumuman"></a>
                </p>
