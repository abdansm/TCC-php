...
<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-T3c6CoIi6uLrA9TneNEoa7RxnatzjcDSCmG1MXxSR1GAsXEV/Dwwykc2MPK8M2HN" crossorigin="anonymous">
    ...
    <title>Seluruh Data Pasien</title>
</head>
...
<nav class="navbar fixed-top navbar-dark" style="background-color: #0766ad;">
  <div class="container-fluid">
    <a class="navbar-brand" href="si-semuapasien.php">Seluruh Data Pasien</a>
...
<?php
    ...
    $query = "SELECT * FROM `data_pengguna` JOIN pengguna WHERE data_pengguna.akun = pengguna.username AND pengguna.status = 'menunggu' ; ";
...
<table class="table">
    ...
    foreach($data as $row) { ?>
        ...
        <tr>
            ...
            <td><?= $row["username"] ?></td>
            <td><?= $row["status"] ?></td>
            <td><a class="btn btn-primary" href="si-verifikasi.php?username=<?= $row ["username"]; ?>">Verifikasi</a>
            </td>
        </tr>
